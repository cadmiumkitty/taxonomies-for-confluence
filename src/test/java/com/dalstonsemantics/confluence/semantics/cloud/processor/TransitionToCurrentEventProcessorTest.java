...
public class TransitionToCurrentEventProcessorTest {
    ...
    @Autowired
    private TransitionToCurrentEventProcessor processor;
    ...
    public void shouldCalculateTaxonomyVersionDifference() throws IOException {
        ...
        FileSystemResource taxonomyVersion = new FileSystemResource("./src/test/resources/repositories/client/taxonomy-version-transitioning_to_current-927294f7-0a9f-3d01-8120-b3ca3a45df38.ttl");
    ...
    @Test
    @Order(10)
    public void shouldProcessTransitionToCurrentEvent() throws Exception {

        FileSystemResource event = new FileSystemResource("./src/test/resources/events/transition-to-current.ttl");
        ...
        assertEquals(Files.readString(Paths.get("./src/test/resources/responses/processor/TransitionToCurrent.txt")), taxonomyVersion.getBody());
    }
}
