...
public class ImportResourceEventProcessorTest {
    ...
    @Autowired
    private ImportResourceEventProcessor processor;
    ...
    public void shouldCalculateTaxonomyVersionDifference() throws IOException {
        ...
        FileSystemResource taxonomyVersion = new FileSystemResource("./src/test/resources/repositories/client/taxonomy-version-importing-resource-927294f7-0a9f-3d01-8120-b3ca3a45df38.ttl");
    ...
    @Test
    @Order(10)
    public void shouldProcessImportResourceEvent() throws Exception {

        FileSystemResource event = new FileSystemResource("./src/test/resources/events/import-resource.ttl");
        ...
        assertEquals(Files.readString(Paths.get("./src/test/resources/responses/processor/ImportResource.txt")), taxonomyVersion.getBody());   
    }
