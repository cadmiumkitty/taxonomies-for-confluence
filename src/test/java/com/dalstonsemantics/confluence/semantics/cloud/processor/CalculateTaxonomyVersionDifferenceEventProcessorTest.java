...
public class CalculateTaxonomyVersionDifferenceEventProcessorTest {
    ...
    @Autowired
    private CalculateTaxonomyVersionDifferenceEventProcessor processor;
    ...
    public void shouldCalculateTaxonomyVersionDifference() throws IOException {
        ...
        FileSystemResource taxonomyVersion = new FileSystemResource("./src/test/resources/repositories/client/taxonomy-version-calculating_taxonomy_version_difference-927294f7-0a9f-3d01-8120-b3ca3a45df38.ttl");
    ...
    @Test
    @Order(10)
    public void shouldProcessCalculateTaxonomyVersionDifferenceEvent() throws Exception {

        FileSystemResource event = new FileSystemResource("./src/test/resources/events/calculate-taxonomy-version-difference.ttl");
        ...
        assertEquals(Files.readString(Paths.get("./src/test/resources/responses/processor/CalculateTaxonomyVersionDifference.txt")), taxonomyVersion.getBody());
    }
}
