...
public class CalculateContentImpactEventProcessorTest {
    ...
    @Autowired
    private CalculateContentImpactEventProcessor processor;
    ...
    @Test
    @Order(10)
    public void shouldProcessCalculateContentImpactEvent() throws Exception {

        FileSystemResource event = new FileSystemResource("./src/test/resources/events/calculate-content-impact.ttl");
        ...
        assertEquals(Files.readString(Paths.get("./src/test/resources/responses/processor/CalculateContentImpact.txt")), taxonomyVersion.getBody());
    }
}
