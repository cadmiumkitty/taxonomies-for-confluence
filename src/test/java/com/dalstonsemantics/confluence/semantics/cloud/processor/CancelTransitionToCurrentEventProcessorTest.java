...
public class CancelTransitionToCurrentEventProcessorTest {
    ...
    @Autowired
    private CancelTransitionToCurrentEventProcessor processor;
    ...
    public void shouldCalculateTaxonomyVersionDifference() throws IOException {
        ...
        FileSystemResource taxonomyVersion = new FileSystemResource("./src/test/resources/repositories/client/taxonomy-version-cancelling_transition_to_current-927294f7-0a9f-3d01-8120-b3ca3a45df38.ttl");
    ...
    @Test
    @Order(10)
    public void shouldProcessCancelTransitionToCurrentEvent() throws Exception {

        FileSystemResource event = new FileSystemResource("./src/test/resources/events/cancel-transition-to-current.ttl");
        ...
        assertEquals(Files.readString(Paths.get("./src/test/resources/responses/processor/CancelTransitionToCurrent.txt")), taxonomyVersion.getBody());
    }
}
